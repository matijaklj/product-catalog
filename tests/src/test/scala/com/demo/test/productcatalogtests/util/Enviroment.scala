...
object Enviroment {
  val baseURL = scala.util.Properties.envOrElse("baseURL", "http://35.240.43.86:5000/v1")
  ...
  val writeUrl = scala.util.Properties.envOrElse("writeUrl", "http://35.240.43.86:4000/v1")
  val readUrl = scala.util.Properties.envOrElse("writeUrl", "http://35.240.43.86:5000/v1")
